...
bowlers_pp = bowlers_pp[bowlers_pp['balls']>=60]
    
bowlers_pp.sort_values('balls_per_boundary', axis = 0, ascending = False, \
                 inplace = True, na_position ='last') 

x_data = [bowlers_pp.iloc[i,7] for i in range(10,-1,-1)]
...
plt.title("Balls per Boundary in the powerplay IPL 2019 (min 60 balls)")
